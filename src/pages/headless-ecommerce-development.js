...
import expandUserbase from "../svgs/undraw-userbase.svg";
...
const canHelp = [
  {
    heading: "Headless Ecommerce Development From Scratch",
    ...
    imageAlt: "Headless Ecommerce Development From Scratch",
    order: "0",
  },
  {
    heading: "Seamless Headless Website Launch",
    ...
    imageAlt: "Seamless Headless Website Launch",
    order: "1",
  },
  {
    heading: "Headless Ecommerce Website Optimization",
    ...
    imageAlt: "Headless Ecommerce Website Optimization",
    order: "0",
  },
];
        ...
        <div className="container py-5">
          <div className="row justify-content-between align-items-center g-5">
            ...
            <div className="col-12 col-md-8 col-xl-5 mx-auto text-center">
              <Zoom>
                <img src={expandUserbase} className="img-fluid" />
              </Zoom>
            </div>
          </div>
        </div>
