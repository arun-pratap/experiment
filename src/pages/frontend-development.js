...
import scaleBusiness from "../svgs/undraw-scale.svg";
...
const canHelp = [
  {
    heading: "Frontend Development From Scratch",
...
const offers = [
  {
    ...
    heading: "Frontend Strategy and Consultation",
  ...
  },
  {
    ...
    para: "We provide CMS (Content Management System) development and integration services to build a fully-functional frontend of website.",
  },
  {
    iconImage: integration,
    iconAlt: "Integration",
    heading: "Third Party Integration",
    para: "Get real-time updates on customers’ actions, behaviour and other important information by integrating any CRM, CMS, and ERP using APIs.",
  },
        ...
        <div className="container py-5">
          <div className="row justify-content-between align-items-center g-5">
            ...
            <div className="col-12 col-md-8 col-xl-5 mx-auto text-center">
              <Zoom>
                <img src={scaleBusiness} className="img-fluid" />
              </Zoom>
            </div>
          </div>
        </div>
